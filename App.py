# Developed by G CHARAN   Made with Streamlit
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://rb.gy/slt97x" style="text-decoration: none; color: #02432;">G CHARAN</a></b>' 
    ...
    if choice == 'User':
        ...
        # Upload Resume
        st.markdown('''<h5 style='text-align: left; color: #02431;'> Upload Your Resume, And Get Smart Recommendations</h5>''',unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://rb.gy/slt97x" style="text-decoration: none; color: grey;">G CHARAN AND TEAM</a>
